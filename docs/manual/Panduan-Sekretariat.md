...
<!-- screenshot: dashboard-sekretariat-overview -->
> 📸 *[Gambar: Tampilan penuh Dashboard Sekretariat — 6 KPI cards di atas, panel surat terbaru, kegiatan mendatang, dan ringkasan booking]*
...
<!-- screenshot: dashboard-banner-notifikasi -->
> 📸 *[Gambar: Banner notifikasi merah di bagian atas dashboard — contoh peringatan workflow tertahan]*
...
<!-- screenshot: persuratan-tabel-surat -->
> 📸 *[Gambar: Tabel daftar surat — tab Semua/Keluar/Masuk, filter kategori, dan badge status berwarna di setiap baris]*
...
> 📸 *[Gambar: Modal formulir "Buat Surat Baru" — semua kolom terisi: nomor, perihal, tujuan, isi, kategori, status, dan tombol Simpan]*
...
<!-- screenshot: persuratan-detail-alur -->
> 📸 *[Gambar: Modal detail surat — bagian alur persetujuan 4 tahap dengan indikator tahap yang sudah selesai (centang) dan yang sedang berjalan]*
...
<!-- screenshot: booking-ruang-denah -->
> 📸 *[Gambar: Tampilan halaman Booking Ruang — kalender mini di kiri, denah lantai interaktif di kanan dengan ruangan berwarna hijau/merah/abu-abu]*
...
<!-- screenshot: booking-ruang-form -->
> 📸 *[Gambar: Modal formulir booking — dropdown ruangan, nama pemohon, date picker, jam mulai/selesai, kolom keperluan, dan tombol "Kirim Permohonan"]*
...
<!-- screenshot: booking-ruang-tabel-konfirmasi -->
> 📸 *[Gambar: Tabel daftar booking — baris dengan status "Menunggu" dan tombol Konfirmasi (hijau) serta Tolak (merah)]*
...
<!-- screenshot: kalender-tampilan-bulan -->
> 📸 *[Gambar: Tampilan kalender satu bulan penuh — tanggal hari ini berwarna emas, event berwarna-warni di beberapa tanggal, dan legenda jenis kegiatan di atas]*
...
<!-- screenshot: notulensi-daftar-kartu -->
> 📸 *[Gambar: Daftar kartu notulensi — judul, badge status, tanggal, peserta, dan chip agenda di setiap kartu]*
...
<!-- screenshot: notulensi-detail-modal -->
> 📸 *[Gambar: Modal detail notulensi — bagian peserta, agenda bernomor, keputusan, dan tabel tindak lanjut dengan kolom penanggung jawab dan tenggat]*
...
<!-- screenshot: notulensi-form-baru -->
> 📸 *[Gambar: Halaman formulir notulensi baru — kolom judul, tanggal, peserta, agenda, keputusan, tindak lanjut, dan pilihan label/akses]*
...
<!-- screenshot: renja-ringkasan-anggaran -->
> 📸 *[Gambar: Panel ringkasan RKAT — total anggaran, realisasi, persentase serapan dengan warna indikator, dan bilah kemajuan keseluruhan]*
...
<!-- screenshot: sop-kartu-diperluas -->
> 📸 *[Gambar: Kartu SOP dalam kondisi diperluas — nomor, versi, ringkasan, dan langkah-langkah bernomor]*
