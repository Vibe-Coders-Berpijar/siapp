...
import { HomeCalendar } from '@/components/shared/HomeCalendar';
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#231F54] via-indigo-900 to-indigo-800 p-6 md:p-10">
      {/* Header */}
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-white">Sistem Informasi Departemen</h1>
        <p className="text-indigo-200 mt-1.5 text-base md:text-lg">Politik Pemerintahan — Universitas Gadjah Mada</p>
      ...
      {/* Main content: role cards + calendar */}
      ...
      {/* Footer */}
      <p className="text-indigo-400 text-xs text-center mt-10">
