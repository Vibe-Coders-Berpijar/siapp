export const currentUser = {
  nama: 'Dr. Anak Agung Gde Ngurah Ari Dwipayana',
  role: 'kadep' as const,
...
export const pendingApprovals = [
  {
    ...
    perihal: 'Surat Tugas Penelitian Lapangan — Dr. Bayu Dardias Kurniadi',
    pengaju: 'Dr. Bayu Dardias Kurniadi',
    tanggal: '6 Mei 2026',
    status: 'menunggu',
  },
  {
...
export const dosenData = [
  { id: 1, nama: 'Prof. Dr. Purwo Santoso, M.A.', jabatan: 'Guru Besar', nidn: '0004026309', publikasi: 12, sks: 9, hibahAktif: 2 },
  { id: 2, nama: 'Prof. Dr. Amalinda Savirani, S.IP., M.A.', jabatan: 'Guru Besar', nidn: '0028017403', publikasi: 10, sks: 8, hibahAktif: 1 },
  { id: 3, nama: "Wawan Mas'udi, S.IP., M.P.A., Ph.D.", jabatan: 'Lektor Kepala', nidn: '0017057703', publikasi: 7, sks: 12, hibahAktif: 1 },
  { id: 4, nama: 'Dr. Mada Sukmajati, S.IP., M.P.P.', jabatan: 'Lektor Kepala', nidn: '0025047603', publikasi: 6, sks: 10, hibahAktif: 1 },
  { id: 5, nama: 'Dr. Nanang Indra Kurniawan, S.IP., M.P.A.', jabatan: 'Lektor Kepala', nidn: '0014017706', publikasi: 5, sks: 12, hibahAktif: 0 },
  { id: 6, nama: 'Dr. Bayu Dardias Kurniadi, S.I.P., M.A.', jabatan: 'Lektor', nidn: '0014067808', publikasi: 4, sks: 14, hibahAktif: 0 },
  { id: 7, nama: 'Hasrul Hanif, S.I.P., M.A., Ph.D.', jabatan: 'Lektor', nidn: '0006048005', publikasi: 3, sks: 14, hibahAktif: 0 },
  { id: 8, nama: 'Arie Ruhyanto, S.IP., M.Sc., Ph.D.', jabatan: 'Lektor', nidn: '0003057806', publikasi: 2, sks: 12, hibahAktif: 0 },
  { id: 9, nama: 'Arya Budi, S.I.P., MAPS.', jabatan: 'Asisten Ahli', nidn: '0019038904', publikasi: 1, sks: 12, hibahAktif: 0 },
  { id: 10, nama: 'Alfath Bagus Panuntun El Nur Indonesia, S.I.P., M.A.', jabatan: 'Asisten Ahli', nidn: '0003089405', publikasi: 0, sks: 10, hibahAktif: 0 },
]
...
export const hibahData = [
  { id: 1, judul: 'Riset Tata Kelola Digital Daerah', funder: 'Kemdiktisaintek', nilai: 285, status: 'aktif', periode: '2025–2026', pic: 'Prof. Dr. Purwo Santoso' },
  { id: 2, judul: 'Ketahanan Birokrasi Pasca-Pandemi', funder: 'LPDP', nilai: 450, status: 'aktif', periode: '2024–2026', pic: 'Prof. Dr. Amalinda Savirani' },
  { id: 3, judul: 'Model Partisipasi Publik Digital', funder: 'Kemdiktisaintek', nilai: 190, status: 'aktif', periode: '2025–2026', pic: 'Dr. Nanang Indra Kurniawan' },
  { id: 4, judul: 'Analisis Kebijakan dan Tata Kelola Daerah', funder: 'Kemdiktisaintek', nilai: 120, status: 'pengajuan', periode: '2026–2027', pic: 'Dr. Mada Sukmajati' },
  { id: 5, judul: 'Reformasi Politik dan Demokratisasi Digital', funder: 'LPDP', nilai: 380, status: 'pengajuan', periode: '2026–2027', pic: "Wawan Mas'udi" },
]
...
export const aiInsights = [
  {
    ...
    aksi: 'Kirim pengingat ke Ashari Cahyo Edi dan Longgina Novadona Bayo',
  },
  {
    id: 2,
    kriteria: 'K9 — Luaran',
  ...
  },
  {
    ...
    metrics: [
      { id: 'k4_s3', label: '% dosen DTPS bergelar S3 (doktor) — target LAMSPAK ≥60%', unit: '%', current: 60, target: 80, weight: 0.30, hint: 'Upload SK Kepangkatan dan fotokopi ijazah S3 tiap dosen DTPS; verifikasi melalui PDDIKTI', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k4s3_1', f1: 'Prof. Dr. Purwo Santoso', f2: 'SK Kepangkatan No. 12345/2020', f3: 'S3 Universitas Indonesia — Ilmu Administrasi 2003', tanggal: '1 Mar 2020' },
        { id: 'k4s3_2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'SK Kepangkatan No. 23456/2019', f3: 'S3 Universität Hamburg — Public Administration 2001', tanggal: '1 Apr 2019' },
        { id: 'k4s3_3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'SK Kepangkatan No. 34567/2021', f3: 'S3 UGM — Ilmu Pemerintahan 2015', tanggal: '15 Jun 2021' },
        { id: 'k4s3_4', f1: 'Dr. Mada Sukmajati', f2: 'SK Kepangkatan No. 45678/2022', f3: 'S3 University of Melbourne — Public Policy 2018', tanggal: '1 Jul 2022' },
        { id: 'k4s3_5', f1: "Wawan Mas'udi", f2: 'SK Kepangkatan No. 56789/2023', f3: 'S3 UGM — Administrasi Publik 2021', tanggal: '1 Feb 2023' },
        { id: 'k4s3_6', f1: 'Dr. Bayu Dardias Kurniadi', f2: 'SK Kepangkatan No. 67890/2023', f3: 'S3 Universitas Airlangga — Administrasi Publik 2022', tanggal: '15 Mar 2023' },
        { id: 'k4s3_7', f1: 'Nur Azizah', f2: 'SK Kepangkatan No. 78901/2022', f3: 'S3 UGM — Kebijakan Publik 2020', tanggal: '1 Aug 2022' },
        { id: 'k4s3_8', f1: 'Arie Ruhyanto', f2: 'SK Kepangkatan No. 89012/2024', f3: 'S3 Universitas Padjadjaran — Administrasi Publik 2023', tanggal: '1 Jan 2024' },
        ...
        { id: 'k4s3_17', f1: 'Sekretaris Departemen', f2: 'SK Kepangkatan No. 71234/2021', f3: 'S3 UGM — Ilmu Pemerintahan 2019', tanggal: '15 Jan 2021' },
      ...
      { id: 'k4_lektor_kepala', label: '% dosen dengan jabatan fungsional Lektor Kepala ke atas', unit: '%', current: 40, target: 55, weight: 0.25, hint: 'Upload SK jabatan fungsional dosen yang masih berlaku dari Kemendikbud', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k4lk1', f1: 'Prof. Dr. Purwo Santoso', f2: 'SK Guru Besar No. 12345/2018', f3: 'Guru Besar — Ilmu Administrasi Publik', tanggal: '1 Sep 2018' },
        { id: 'k4lk2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'SK Guru Besar No. 23456/2016', f3: 'Guru Besar — Ilmu Pemerintahan', tanggal: '1 Mar 2016' },
        { id: 'k4lk3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'SK Lektor Kepala No. 34567/2020', f3: 'Lektor Kepala — Administrasi Publik', tanggal: '1 Apr 2020' },
        { id: 'k4lk4', f1: 'Dr. Mada Sukmajati', f2: 'SK Lektor Kepala No. 45678/2021', f3: 'Lektor Kepala — Kebijakan Publik', tanggal: '15 Jan 2021' },
        { id: 'k4lk5', f1: "Wawan Mas'udi", f2: 'SK Lektor Kepala No. 56789/2022', f3: 'Lektor Kepala — Ilmu Pemerintahan', tanggal: '1 Jul 2022' },
        ...
        { id: 'k4lk11', f1: 'Sekretaris Departemen', f2: 'SK Lektor Kepala No. 11234/2023', f3: 'Lektor Kepala — Administrasi Publik', tanggal: '15 Jan 2023' },
      ...
      { id: 'k4_serdos', label: '% dosen bersertifikasi pendidik (Serdos/NRD)', unit: '%', current: 50, target: 75, weight: 0.20, hint: 'Upload sertifikat pendidik profesional (NRD) tiap dosen yang telah tersertifikasi', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k4sd1', f1: 'Prof. Dr. Purwo Santoso', f2: 'NRD 8810126801025001', f3: 'Serdos 2010 — Ilmu Administrasi', tanggal: '15 Des 2010' },
        { id: 'k4sd2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'NRD 8810237502014002', f3: 'Serdos 2008 — Ilmu Pemerintahan', tanggal: '10 Nov 2008' },
        { id: 'k4sd3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'NRD 8810148401023003', f3: 'Serdos 2016 — Administrasi Publik', tanggal: '5 Jan 2016' },
        { id: 'k4sd4', f1: 'Dr. Mada Sukmajati', f2: 'NRD 8810318502012004', f3: 'Serdos 2019 — Kebijakan Publik', tanggal: '20 Mar 2019' },
        { id: 'k4sd5', f1: "Wawan Mas'udi", f2: 'NRD 8810087901011005', f3: 'Serdos 2021 — Ilmu Pemerintahan', tanggal: '15 Jun 2021' },
        { id: 'k4sd6', f1: 'Dr. Bayu Dardias Kurniadi', f2: 'NRD 8810179301010006', f3: 'Serdos 2022 — Administrasi Publik', tanggal: '10 Jul 2022' },
        { id: 'k4sd7', f1: 'Nur Azizah', f2: 'NRD 8810258902009007', f3: 'Serdos 2021 — Kebijakan Publik', tanggal: '25 Feb 2021' },
      ...
      { id: 'k4_guru_besar', label: '% Guru Besar dari total DTPS — target LAMSPAK ≥10%', unit: '%', current: 13, target: 20, weight: 0.15, hint: 'Upload SK Guru Besar/Profesor dari Kemendikbud beserta SK pengangkatan aktif', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k4gb1', f1: 'Prof. Dr. Purwo Santoso', f2: 'SK Guru Besar No. 12345/M/2018', f3: 'Guru Besar Ilmu Administrasi Publik — NIDN 0012056801', tanggal: '1 Sep 2018' },
        { id: 'k4gb2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'SK Guru Besar No. 23456/M/2016', f3: 'Guru Besar Ilmu Pemerintahan — NIDN 0023047502', tanggal: '1 Mar 2016' },
      ...
      { id: 'k4_bkd', label: '% dosen yang upload BKD tepat waktu semester ini', unit: '%', current: 80, target: 100, weight: 0.10, hint: 'Upload rekap BKD dari SISTER/sistem kepegawaian universitas per semester berjalan', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k4bkd1', f1: 'Prof. Dr. Purwo Santoso', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 28 Apr 2025', tanggal: '28 Apr 2025' },
        { id: 'k4bkd2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 25 Apr 2025', tanggal: '25 Apr 2025' },
        { id: 'k4bkd3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 30 Apr 2025', tanggal: '30 Apr 2025' },
        { id: 'k4bkd4', f1: 'Dr. Mada Sukmajati', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 29 Apr 2025', tanggal: '29 Apr 2025' },
        { id: 'k4bkd5', f1: "Wawan Mas'udi", f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 27 Apr 2025', tanggal: '27 Apr 2025' },
        { id: 'k4bkd6', f1: 'Nur Azizah', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 26 Apr 2025', tanggal: '26 Apr 2025' },
        { id: 'k4bkd7', f1: 'Arie Ruhyanto', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 28 Apr 2025', tanggal: '28 Apr 2025' },
        ...
        { id: 'k4bkd17', f1: 'Sekretaris Departemen', f2: 'BKD Genap 2024/2025', f3: 'Upload via SISTER — 29 Apr 2025', tanggal: '29 Apr 2025' },
  ...
  },
  {
    ...
    metrics: [
      { id: 'k7_pub_intl', label: 'Publikasi internasional per dosen DTPS per tahun — target LAMSPAK Unggul ≥0,5', unit: 'pub/dosen/thn', current: 0.38, target: 0.5, weight: 0.35, hint: 'Upload bukti publikasi (URL/DOI Scopus atau WoS) per dosen; sertakan nama dosen dan judul artikel', template: 'publication', autoCompute: { mode: 'ratio', denom: 30 }, entries: [
        { id: 'k7p1', f1: 'Prof. Dr. Purwo Santoso', f2: 'Digital Governance in Regional Governments of Indonesia', f3: '10.1080/14719037.2025.2001234', tanggal: '15 Mar 2025' },
        { id: 'k7p2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'Bureaucratic Resilience Post-Pandemic: Evidence from Indonesian Cities', f3: '10.1177/0020852325001234', tanggal: '20 Jan 2025' },
        { id: 'k7p3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'Public Participation in Digital Era: A Comparative Study', f3: '10.1016/j.giq.2025.101876', tanggal: '5 Feb 2025' },
        { id: 'k7p4', f1: 'Dr. Mada Sukmajati', f2: 'Local Fiscal Policy and Regional Economic Growth in Java', f3: '10.1007/s11115-025-00601-2', tanggal: '12 Apr 2025' },
        { id: 'k7p5', f1: "Wawan Mas'udi", f2: 'Administrative Reform in Indonesian Municipal Governments', f3: '10.1093/jopart/muac025', tanggal: '3 Mar 2025' },
        { id: 'k7p6', f1: 'Prof. Dr. Purwo Santoso', f2: 'E-Governance Framework Evaluation in Local Governments', f3: '10.1108/IJPSM-2025-0001', tanggal: '22 Feb 2025' },
        { id: 'k7p7', f1: 'Prof. Dr. Amalinda Savirani', f2: 'Public Sector Innovation Diffusion in Developing Countries', f3: '10.1080/09540962.2025.001234', tanggal: '10 Apr 2025' },
        { id: 'k7p8', f1: 'Dr. Nanang Indra Kurniawan', f2: 'Digital Service Quality and Citizen Satisfaction in Public Sector', f3: '10.1177/0095399725001234', tanggal: '28 Jan 2025' },
        { id: 'k7p9', f1: 'Dr. Bayu Dardias Kurniadi', f2: 'Grassroots Democracy and Village Governance in Indonesia', f3: '10.1016/j.polsoc.2025.100234', tanggal: '18 Mar 2025' },
        { id: 'k7p10', f1: 'Dr. Mada Sukmajati', f2: 'Tax Revenue Decentralization and Subnational Government Performance', f3: '10.1007/s10611-025-10001-2', tanggal: '7 Apr 2025' },
        { id: 'k7p11', f1: 'Nur Azizah', f2: 'Gender Responsive Budgeting Implementation in Indonesian Local Governments', f3: '10.1093/pa/gqad025', tanggal: '25 Mar 2025' },
      ] },
      { id: 'k7_pct_intl', label: '% dosen DTPS dengan minimal 1 publikasi internasional/tahun', unit: '%', current: 50, target: 70, weight: 0.25, hint: 'Upload daftar dosen beserta link publikasi internasionalnya (Scopus/WoS/Google Scholar terverifikasi)', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k7pct1', f1: 'Prof. Dr. Purwo Santoso', f2: 'Scopus ID: 57196234501', f3: 'scholar.google.com/citations?user=hery_santoso', tanggal: 'Apr 2025' },
        { id: 'k7pct2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'Scopus ID: 57197345612', f3: 'scholar.google.com/citations?user=bambang_w', tanggal: 'Apr 2025' },
        { id: 'k7pct3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'Scopus ID: 57198456723', f3: 'scholar.google.com/citations?user=ratih_dk', tanggal: 'Apr 2025' },
        { id: 'k7pct4', f1: 'Dr. Mada Sukmajati', f2: 'Scopus ID: 57199567834', f3: 'scholar.google.com/citations?user=maya_indira', tanggal: 'Apr 2025' },
        { id: 'k7pct5', f1: "Wawan Mas'udi", f2: 'Scopus ID: 57200678945', f3: 'scholar.google.com/citations?user=reza_p', tanggal: 'Apr 2025' },
        { id: 'k7pct6', f1: 'Dr. Bayu Dardias Kurniadi', f2: 'Scopus ID: 57201789056', f3: 'scholar.google.com/citations?user=ahmad_fauzi', tanggal: 'Apr 2025' },
        { id: 'k7pct7', f1: 'Nur Azizah', f2: 'Scopus ID: 57202890167', f3: 'scholar.google.com/citations?user=siti_n', tanggal: 'Apr 2025' },
      ...
      { id: 'k7_hki', label: 'Jumlah HKI aktif (paten dan hak cipta) 3 tahun terakhir', unit: 'HKI', current: 3, target: 6, weight: 0.20, hint: 'Upload sertifikat HKI dari Kemenkumham beserta nomor registrasi dan tanggal penerbitan', template: 'document', autoCompute: { mode: 'count' }, entries: [
        { id: 'k7hki1', f1: 'Model Tata Kelola Digital Daerah', f2: 'EC00202412345', f3: 'Hak Cipta — Kemenkumham, atas nama Prof. Dr. Purwo Santoso', tanggal: '15 Jun 2024' },
        { id: 'k7hki2', f1: 'Sistem Monitoring Partisipasi Publik Berbasis Data', f2: 'EC00202398765', f3: 'Hak Cipta — Kemenkumham, atas nama Dr. Nanang Indra Kurniawan', tanggal: '20 Sep 2023' },
        { id: 'k7hki3', f1: 'Metode Evaluasi Kinerja Birokrasi Digital', f2: 'EC00202378901', f3: 'Hak Cipta — Kemenkumham, atas nama Prof. Dr. Amalinda Savirani', tanggal: '5 Jan 2023' },
      ] },
  ...
  },
  {
    ...
    metrics: [
      ...
      { id: 'k8_pct_dosen', label: '% dosen DTPS yang melaksanakan minimal 1 PkM per tahun', unit: '%', current: 60, target: 80, weight: 0.30, hint: 'Upload daftar dosen yang telah melaksanakan PkM beserta bukti laporan akhir kegiatan', template: 'person', autoCompute: { mode: 'percent', denom: 30 }, entries: [
        { id: 'k8pd1', f1: 'Prof. Dr. Purwo Santoso', f2: 'SK PkM No. 01/DPP/2024', f3: 'PkM: Penguatan Tata Kelola Digital Pemda DIY', tanggal: 'Mar 2024' },
        { id: 'k8pd2', f1: 'Prof. Dr. Amalinda Savirani', f2: 'SK PkM No. 02/DPP/2024', f3: 'PkM: Reformasi Birokrasi Kabupaten Sleman', tanggal: 'Apr 2024' },
        { id: 'k8pd3', f1: 'Dr. Nanang Indra Kurniawan', f2: 'SK PkM No. 03/DPP/2024', f3: 'PkM: Pelatihan Partisipasi Publik Digital, Kota Yogyakarta', tanggal: 'Mei 2024' },
        { id: 'k8pd4', f1: 'Dr. Mada Sukmajati', f2: 'SK PkM No. 04/DPP/2024', f3: 'PkM: Pendampingan Anggaran Responsif Gender Bantul', tanggal: 'Mar 2024' },
        { id: 'k8pd5', f1: "Wawan Mas'udi", f2: 'SK PkM No. 05/DPP/2024', f3: 'PkM: Penguatan Kapasitas DPRD Kabupaten Gunungkidul', tanggal: 'Apr 2024' },
        { id: 'k8pd6', f1: 'Dr. Bayu Dardias Kurniadi', f2: 'SK PkM No. 06/DPP/2024', f3: 'PkM: Pendampingan Pemerintah Desa Berbasis Data, Sleman', tanggal: 'Jun 2024' },
        { id: 'k8pd7', f1: 'Nur Azizah', f2: 'SK PkM No. 07/DPP/2024', f3: 'PkM: Sosialisasi Gender Responsive Budgeting, Kemenpppa', tanggal: 'Mei 2024' },
      ...
      { id: 'k8_output', label: 'Output PkM yang dipublikasikan (artikel/prosiding/buku/TTG) per tahun', unit: 'output/thn', current: 8, target: 12, weight: 0.15, hint: 'Upload bukti publikasi output PkM: jurnal pengabdian ber-ISSN, ISBN buku, atau sertifikat TTG', template: 'publication', autoCompute: { mode: 'count' }, entries: [
        { id: 'k8op1', f1: 'Dr. Nanang Indra Kurniawan', f2: 'Penguatan Partisipasi Publik Digital: Pengalaman Kota Yogyakarta', f3: 'Jurnal Pengabdian kepada Masyarakat UGM, Vol.9 No.1 2024, ISSN 2477-5347', tanggal: 'Mar 2024' },
        { id: 'k8op2', f1: 'Dr. Bayu Dardias Kurniadi', f2: 'Pendampingan Desa Berbasis Data: Replikasi Model Desa Mandiri Digital', f3: 'Seminar Nasional Administrasi Publik 2024, Prosiding ISBN 978-602-5428-22-1', tanggal: 'Jun 2024' },
        { id: 'k8op3', f1: 'Prof. Dr. Purwo Santoso', f2: 'Tata Kelola Digital Pemerintah Daerah: Panduan Praktis', f3: 'Penerbit UGM Press, ISBN 978-602-386-210-4', tanggal: 'Agt 2024' },
        { id: 'k8op4', f1: 'Nur Azizah', f2: 'Gender Responsive Budgeting di Pemerintah Daerah: Studi Kasus Bantul', f3: 'Jurnal Ilmu Administrasi Publik JISIP, Vol.12 No.2 2024, ISSN 2599-3593', tanggal: 'Sep 2024' },
